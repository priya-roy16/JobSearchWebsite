...
%>
<h1><font color="green"><strong>PERSONALITY QUIZ</strong></font></h1><br><br>
...
%>
<tr bgcolor="white">
<form action="personalityquiz1.jsp" method="post">
    <td><input type="text" name="pquestion" size="40" value="<%=resultSet.getString("question_number")%>" readonly></td>
<td><%=resultSet.getString("question") %></td>
<td><input type="text" name="panswer" size="40"></td>
